...
class Mapos extends MY_Controller
{
    ...
    public function configurar()
    {
        ...
        $this->form_validation->set_rules('exibir_feed_instagram', 'Exibir ou não Feed do Instagram', 'required|trim');
        $this->form_validation->set_rules('insta_token', 'Insira seu código TOKEN', 'trim');
        $this->form_validation->set_rules('insta_link', 'Insira seu link do instagram', 'trim');
        $this->form_validation->set_rules('link_whatsapp', 'Insira seu link do whatsApp', 'trim');
