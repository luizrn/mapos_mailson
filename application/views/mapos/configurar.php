            ...
            <form action="<?php echo current_url(); ?>" id="formConfigurar" method="post" class="form-horizontal">
                <div class="widget-content nopadding tab-content">
                    ...
                    <div id="home" class="tab-pane fade in active">
                        ...
                        <div class="control-group">
                            <label for="control_datatable" class="control-label">Exibir ou não Feed do Instagram</label>
                            <div class="controls">
                                <select name="exibir_feed_instagram" id="exibir_feed_instagram">
                                    <option value="1">Sim</option>
                                    <option value="0" <?= $configuration['exibir_feed_instagram'] == '0' ? 'selected' : ''; ?>>Não</option>
                                </select>
                                <span class="help-inline">Ativar ou desativar a visualização do Feed do Instagram</span>
                            </div>
                        </div>
                        <div class="control-group">
                           <label for="app_name" class="control-label">TOKEN do Instagram</label>
                           <div class="controls">
                               <input type="text" id="insta_token" name="insta_token" value="<?= $configuration['insta_token'] ?>">
                       ...
                       <div class="control-group">
                           ...
                           <div class="controls">
                               <input type="text" id="insta_link" name="insta_link" value="<?= $configuration['insta_link'] ?>">
                               <span class="help-inline">Insira seu link do instagram aqui</span>
                           </div>
                       </div>
                       <div class="control-group">
                           <label for="app_name" class="control-label">Link do WhatsApp</label>
                           <div class="controls">
                               <input type="text" id="link_whatsapp" name="link_whatsapp" value="<?= $configuration['link_whatsapp'] ?>">
                               <span class="help-inline">Insira seu link do whatsApp aqui</span>
                           </div>
                       </div>
